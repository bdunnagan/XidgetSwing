 ...
 */
public class BarChartWidgetCreationFeature extends SwingWidgetCreationFeature
{
  public BarChartWidgetCreationFeature( IXidget xidget)
  {
    super( xidget);
  }
  ...
  {
    boolean horizontal = Xlate.get( xidget.getConfig(), "orientation", "vertical").equals( "horizontal");
    chart = new BarChart( horizontal);
    findGraphAxes( chart);
    return chart;
  }
   ...
   */
  private void findGraphAxes( BarChart chart)
  {
  ...
  /**
   * Returns the BarChart widget which may be different from the widget returned
