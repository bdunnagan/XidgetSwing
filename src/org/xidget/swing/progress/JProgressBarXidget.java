...
public class JProgressBarXidget extends Xidget
{
  ...
  protected void createFeatures()
  {
    ...
    singleValueWidgetFeature = new JProgressBarValueWidgetFeature( this);
    sliderFeature = new JProgressBarWidgetFeature( this);
    creationFeature = new JProgressBarWidgetCreationFeature( this);
  ...
  public <T> T getFeature( Class<T> clss)
  {
    ...
    if ( clss == JProgressBar.class) return (T)creationFeature.getJProgressBar();
